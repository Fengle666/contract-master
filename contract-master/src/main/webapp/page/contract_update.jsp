                     	...
                     	<div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="payState" required="required">
                                	<option value="0" <c:if test="${contract.payState eq 0  }">select="select"</c:if>>未付清</option>
                                	<option value="1" <c:if test="${contract.payState eq 1  }">select="select"</c:if>>已付清</option>
                                </select>
                            </div>
                     ...
                     <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                             ...
                             <label class="control-label"><small>支持多附件</small></label>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                               <select class="form-control" name="state" id="state" required="required">
                               		<option value="0" <c:if test="${contract.state eq 0 }">selected="selected"</c:if>>执行</option>
                               		<option value="1" <c:if test="${contract.state eq 1 }">selected="selected"</c:if>>完成</option>
                               	 	<option value="2" <c:if test="${contract.state eq 2 }">selected="selected"</c:if>>废止</option>
                               </select>
                            </div>
                        </div>
                    </fieldset>
