...
<div class="row">
	<div class="col-md-12">
		<div class="approvald">
			...
			<table id="bootstrap-table" class="table" data-url="${ pageContext.request.contextPath }/approval/approvallist">
				<thead>
					<th data-field="state" data-checkbox="true"></th>
					<th data-field="id" data-formatter="numFormatter">编号</th>
					<th data-field="templateName" data-sortable="true">模板名称</th>
					<th data-field="opinion" data-sortable="true">审批意见</th>
					<th data-field="time" data-sortable="true">审批时间</th>
					<th data-field="userName" data-sortable="true">审批人</th>
...
<script approval="text/javascript">
    ...
    $().ready(function(){
        window.operateEvents = {
            'click .edit': function (e, value, row, index) {
               /* info = JSON.stringify(row);
                ...
                console.log(info);*/
                location.href = "${ pageContext.request.contextPath }/approval/findById?id="+row.id;
            },
        ...
        /**增加方法*/
        $("#add").click(function () {
            window.location.href="${ pageContext.request.contextPath }/page/approval_add.jsp";
        });
